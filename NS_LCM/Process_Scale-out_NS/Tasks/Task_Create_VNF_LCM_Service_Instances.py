...
if __name__ == "__main__":
    ...
    VNF_LCM_CREATE_PROCESS_NAME = 'Process/etsi-mano-workflows/_py__VNF_LCM__VNFD_based-on_SOL001_/Process_Create_VNF_Instance'
    VNF_LCM_INSTANTIATE_PROCESS_NAME = 'Process/etsi-mano-workflows/_py__VNF_LCM__VNFD_based-on_SOL001_/Process_Instantiate_VNF'
