...
if __name__ == "__main__":
    ...
    dev_var.add('ns_descriptor_id', var_type='String')
    ...
    #Execute the operation to get the NS Package details.
    r = nsdApi.nsd_descriptors_get(context["ns_package_id"])
    ...
    #Store NSD id into the context.
    context["ns_descriptor_id"] = r.json()["nsdId"]
